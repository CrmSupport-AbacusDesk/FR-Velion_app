...
.service('myRequestDBService',function($q, $http,$state, myAllSharedService, $ionicLoading, $ionicPopup) {
    ...
    return {
        ...
        distributorPendingOrderDetail: function(orderId) {

          var deferred = $q.defer();
          var promise = deferred.promise;

          $http.post(serverURL+"/okaya_orp/invoice/distributorPendingOrderDetail", {
        ...
        getOrderList: function(order_type, searchData, currentPage, pageSize,createdBy,data)
        {
            var deferred = $q.defer();
            var promise = deferred.promise;
        ...
        getdoclist: function() {
          ...
          $http.post(orpServerURL+"/ORP_Login/GET_DOCUMENT_TYPE",
          {
        ...
        /* Travel List Start*/
        getTravelList: function(travelPlanStatus, planType) {
            var deferred = $q.defer();
            var promise = deferred.promise;
        ...
        // ----start save bank detais---

        save_BankDetails: function(fn_name,data)
        {
            console.log(fn_name);
            ...
            $http.post(orpServerURL+fn_name,{
              ...
              // loginId: myAllSharedService.loginData.loginId,
                data: data,
        ...
        mobileNoRequest: function(fn_name)
        {
            console.log(fn_name);
...
.factory('myAllSharedService', function() {
    ...
    mySharedService.drTypeFilterData.detail ={};
